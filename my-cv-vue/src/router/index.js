...
import UtbildningView from '../views/UtbildningView.vue'
import JobbView from '../views/JobbView.vue'
import KunskapView from '../views/KunskapView.vue'
import MeriterView from '../views/MeriterView.vue'
...
const routes = [
  ...
  },    
  {
    path: '/kunskap',
    name: 'kunskap',
    component: KunskapView
  },
  {
    path: '/meriter',
    name: 'meriter',
    component: MeriterView
  }        
]
